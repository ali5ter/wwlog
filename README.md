...
[targets]
# All keys are optional. When present, the Nutrition tab bars and --report use
# these values instead of the generic reference daily values.
calories          = [1700, 1900]   # [min, max] kcal/day band
